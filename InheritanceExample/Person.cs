...

{
    public class Person //"public" is an accessability modifier
    {
        ...
        public string FirstName //capital first letter
        {
            get
            {
                return firstName;
            ...
            set
            {
                firstName = value; //Person.FirstName = returns firstName
            }
        }
        ...
        //this opne will have a dirfferent parameter list and thus a different method signature
